    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          description: 'Práctica de Bases de Datos Masivas - procesamiento de grandes volúmenes de datos.',
    ...
    education: {
      ...
      items: [
        ...
        },
        {
          ...
          degree: 'Gestión de Sistemas de Información',
          period: '2011 - 2014',
          description: 'Formación en gestión de sistemas de información, análisis de negocio y tecnologías de la información.',
        },
      ],
    },
    certifications: {
    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          description: 'Massive Databases practice - processing large data volumes.',
          tags: ['Spark', 'Hadoop', 'Big Data'],
          link: 'https://github.com/MoyaBigdataDev/especializacion-bigdata',
        },
      ],
    ...
    education: {
      ...
      items: [
        ...
        },
        {
          ...
          period: '2011 - 2014',
          description: 'Training in information systems management, business analysis, and information technology.',
        },
      ],
    },
    certifications: {
